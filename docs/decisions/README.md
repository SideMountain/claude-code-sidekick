...
| 0034 | [/ux-scan スキル（UX 導線フリクションのプロファイラ）](0034-ux-scan-skill.md) | 採用（2026-07-20・v0.17.0 で実装） |
| 0035 | [並列 Worktree の資源統治（公式ライフサイクル前提・ccs は Resource Governor + Quality Layer）](0035-parallel-worktree-resource-model.md) | 承認済み（2026-08-21） |
